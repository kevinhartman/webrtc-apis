...
ZS_DECLARE_TYPEDEF_PTR(
    wrapper::impl::org::webRtc::MediaStreamTrack::WrapperImplType,
    WrapperImplType);
...
typedef wrapper::impl::org::webRtc::WrapperMapper<NativeType, WrapperImplType>
    UseWrapperMapper;

ZS_DECLARE_TYPEDEF_PTR(wrapper::impl::org::webRtc::WebRtcLib, UseWebrtcLib);
ZS_DECLARE_TYPEDEF_PTR(wrapper::impl::org::webRtc::AudioTrackSource,
                       UseAudioTrackSource);
ZS_DECLARE_TYPEDEF_PTR(wrapper::impl::org::webRtc::VideoTrackSource,
                       UseVideoTrackSource);
...
static ::webrtc::AudioTrackInterface* unproxyAudioTrack(NativeType* native) {
  ...
  return WRAPPER_DEPROXIFY_CLASS(::webrtc::AudioTrack, ::webrtc::AudioTrack,
                                 converted);
}
...
static ::webrtc::VideoTrackInterface* unproxyVideoTrack(NativeType* native) {
  ...
  return WRAPPER_DEPROXIFY_CLASS(::webrtc::VideoTrack, ::webrtc::VideoTrack,
                                 converted);
}
...
#ifdef __cplusplus_winrt
//------------------------------------------------------------------------------
static void notifyAboutNewMediaSource(WrapperImplType& wrapper,
...
//------------------------------------------------------------------------------
static void notifyAboutNewMediaSource(
    WrapperImplType& wrapper,
    winrt::Windows::Media::Core::IMediaSource const& newSource) {
  typedef WrapperImplType::UseMediaSourceImpl UseMediaSourceImpl;
  auto source = UseMediaSourceImpl::toWrapper(newSource);
  wrapper.notifySourceChanged(source);
}
...
//------------------------------------------------------------------------------
wrapper::org::webRtc::MediaStreamTrackPtr
wrapper::org::webRtc::MediaStreamTrack::wrapper_create() noexcept {
...
//------------------------------------------------------------------------------
wrapper::org::webRtc::MediaStreamTrackPtr
wrapper::org::webRtc::MediaStreamTrack::createAudioTrack(
    String label,
    wrapper::org::webRtc::AudioTrackSourcePtr source) noexcept {
  auto factory = UseWebrtcLib::peerConnectionFactory();
  ZS_ASSERT(factory);
  if (!factory)
    return WrapperTypePtr();
...
//------------------------------------------------------------------------------
wrapper::org::webRtc::MediaStreamTrackPtr
wrapper::org::webRtc::MediaStreamTrack::createVideoTrack(
    String label,
    wrapper::org::webRtc::VideoTrackSourcePtr source) noexcept {
  auto factory = UseWebrtcLib::peerConnectionFactory();
  ZS_ASSERT(factory);
  if (!factory)
    return WrapperTypePtr();
...
//------------------------------------------------------------------------------
void wrapper::impl::org::webRtc::MediaStreamTrack::set_enabled(
    bool value) noexcept {
  ZS_ASSERT(native_);
  if (!native_)
    return;
...
//------------------------------------------------------------------------------
wrapper::org::webRtc::MediaStreamTrackState
wrapper::impl::org::webRtc::MediaStreamTrack::get_state() noexcept {
  ZS_ASSERT(native_);
  if (!native_)
    return wrapper::org::webRtc::MediaStreamTrackState::
...
//------------------------------------------------------------------------------
wrapper::org::webRtc::MediaSourcePtr
wrapper::impl::org::webRtc::MediaStreamTrack::get_source() noexcept {
  zsLib::AutoLock lock(lock_);
  return source_;
}

//------------------------------------------------------------------------------
wrapper::org::webRtc::MediaElementPtr
wrapper::impl::org::webRtc::MediaStreamTrack::get_element() noexcept {
  zsLib::AutoLock lock(lock_);
  return element_;
}

//------------------------------------------------------------------------------
void wrapper::impl::org::webRtc::MediaStreamTrack::set_element(
    wrapper::org::webRtc::MediaElementPtr value) noexcept {
  {
    zsLib::AutoLock lock(lock_);
    element_ = value;
  }
...
//------------------------------------------------------------------------------
void wrapper::impl::org::webRtc::MediaStreamTrack::
    wrapper_onObserverCountChanged(ZS_MAYBE_USED() size_t count) noexcept {
  ZS_MAYBE_USED(count);
}
...
#pragma ZS_BUILD_NOTE( \
    "VERIFY", "(mosa) verify this is correct behaviour (REMOVE IF GOOD)")
...
void WrapperImplType::setupObserver() noexcept {
  ...
  if (converted) {
    ...
    videoObserver_ = std::make_shared<WebrtcVideoObserver>(
        thisWeak_.lock(), UseWebrtcLib::delegateQueue());

    rtc::VideoSinkWants wants;

#pragma ZS_BUILD_NOTE( \
    "TODO", "(mosa) you may want to tweak these properties -- not sure")
...
void WrapperImplType::teardownObserver() noexcept {
  ...
  if (videoObserver_) {
    auto converted =
        dynamic_cast<::webrtc::VideoTrackInterface*>(native_.get());
    ZS_ASSERT(converted);
    if (!converted)
      return;
...
//------------------------------------------------------------------------------
void WrapperImplType::notifyWebrtcObserverFrame(
  ...
  if (frameType != currentFrameType_ || !firstFrameReceived_) {
    {
      ...
      currentFrameType_ = frameType;
      mediaStreamSource_ =
          UseMediaStreamSource::CreateMediaSource(frameType, "");
    }
    Windows::Media::Core::IMediaSource ^ source =
        mediaStreamSource_->GetMediaStreamSource();
    notifyAboutNewMediaSource(*this, source);
  }
...
//------------------------------------------------------------------------------
void WrapperImplType::onWebrtcObserverFrameRateChanged(
...
WrapperImplTypePtr WrapperImplType::toWrapper(NativeType* native) noexcept {
  ...
  auto wrapper = mapperSingleton().getExistingOrCreateNew(original, [native]() {
    ...
    result->native_ = rtc::scoped_refptr<NativeType>(
        native);  // only use proxy and never original pointer
...
WrapperImplTypePtr WrapperImplType::toWrapper(
    NativeTypeScopedPtr native) noexcept {
...
//------------------------------------------------------------------------------
WrapperImplTypePtr WrapperImplType::toWrapperBase(
    NativeTypeScopedPtr native) noexcept {
  return toWrapper(native);
}
...
//------------------------------------------------------------------------------
WrapperImplTypePtr WrapperImplType::toWrapper(
    AudioNativeType* native) noexcept {
  return toWrapperBase(native);
}

//------------------------------------------------------------------------------
WrapperImplTypePtr WrapperImplType::toWrapper(
    AudioNativeTypeScopedPtr native) noexcept {
  return toWrapperBase(native.get());
}

//------------------------------------------------------------------------------
WrapperImplTypePtr WrapperImplType::toWrapper(
    VideoNativeType* native) noexcept {
  return toWrapperBase(native);
}

//------------------------------------------------------------------------------
WrapperImplTypePtr WrapperImplType::toWrapper(
    VideoNativeTypeScopedPtr native) noexcept {
  return toWrapperBase(native.get());
}
...
NativeTypeScopedPtr WrapperImplType::toNative(WrapperTypePtr wrapper) noexcept {
  if (!wrapper)
    return rtc::scoped_refptr<NativeType>();
